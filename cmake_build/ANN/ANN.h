...
ANNLIB_EXPORT ANNdist annDist(
	int				dim,		// dimension of space
	ANNpoint		p,			// points
	ANNpoint		q);

ANNLIB_EXPORT ANNpoint annAllocPt(
	int				dim,		// dimension
	ANNcoord		c = 0);		// coordinate value (all equal)

ANNLIB_EXPORT ANNpointArray annAllocPts(
	int				n,			// number of points
	int				dim);		// dimension

ANNLIB_EXPORT void annDeallocPt(
	ANNpoint		&p);		// deallocate 1 point
   
ANNLIB_EXPORT void annDeallocPts(
	ANNpointArray	&pa);		// point array

ANNLIB_EXPORT ANNpoint annCopyPt(
	int				dim,		// dimension
...
class ANNLIB_EXPORT ANNpointSet {
public:
...
class ANNLIB_EXPORT ANNbruteForce: public ANNpointSet {
	int				dim;				// dimension
...
class ANNLIB_EXPORT ANNkd_tree: public ANNpointSet {
protected:
	int				dim;				// dimension of space
...
class ANNLIB_EXPORT ANNbd_tree: public ANNkd_tree {
public:
...
ANNLIB_EXPORT void annMaxPtsVisit(	// max. pts to visit in search
	int				maxPts);	// the limit

ANNLIB_EXPORT void annClose();		// called to end use of ANN
